const Dracaena = {
	...
	imageSrc:'dracSprites/dracIdle.png',
	framesMax:4,
	framesHold:15,
	scale:.615,
	offset:{
	...
	sprites: {
		idle:{
			...
			framesHold:15,
			scale:.615,
			backwardsImg:'dracSprites/dracIdlebackwards.png',
			temp:null,
			offset:{
				x:100,
				y:70
		...
		run:{
			imageSrc:'dracSprites/dracRun.png',
			framesMax:11,
			framesHold:4,
			scale:1.85,
			backwardsImg:'dracSprites/dracRunbackwards.png',
			temp:null,
			offset:{
				x:60,
				y:70
		...
		jump:{
			imageSrc:'dracSprites/dracJump.png',
			framesMax:3,
			framesHold:12,
			scale:.48,
			backwardsImg:'dracSprites/dracJumpbackwards.png',
			temp:null,
			offset:{
				x:60,
				y:70
		...
		fall:{
			imageSrc:'dracSprites/dracFall.png',
			framesMax:2,
			framesHold:6,
			scale:.36,
			backwardsImg:'dracSprites/dracFallbackwards.png',
			temp:null,
			offset:{
				x:60,
				y:70
		...
		attack1:{
			imageSrc:'dracSprites/dracAttack1.png',
			framesMax:4,
			framesHold:5,
			scale:.66,
			backwardsImg:'dracSprites/dracAttack1backwards.png',
			temp:null,
			offset:{
				x:100,
				y:70
		...
		death:{
			imageSrc:'dracSprites/dracDeath.png',
			framesMax:10,
			framesHold:9,
			scale:1.7,
			backwardsImg:'dracSprites/dracDeathbackwards.png',
			temp:null,
			offset:{
				x:60,
				y:70
...
const Richard = {
	...
	imageSrc:'richardSprites/richardIdle.png',
	framesMax:8,
	framesHold:6,
	scale:1.3,
	offset:{
	...
	sprites: {
		idle:{
			...
			framesHold:6,
			scale:1.3,
			backwardsImg:'richardSprites/richardIdlebackwards.png',
			temp:null,
			offset:{
				x:60,
				y:66
		...
		run:{
			imageSrc:'richardSprites/richardRun.png',
			framesMax:7,
			framesHold:6,
			scale:1.18,
			backwardsImg:'richardSprites/richardRunbackwards.png',
			temp:null,
			offset:{
				x:60,
				y:66
		...
		jump:{
			imageSrc:'richardSprites/richardJump.png',
			framesMax:2,
			framesHold:12,
			scale:.4,
			backwardsImg:'richardSprites/richardJumpbackwards.png',
			temp:null,
			offset:{
				x:60,
				y:70
		...
		fall:{
			imageSrc:'richardSprites/richardFall.png',
			framesMax:2,
			framesHold:6,
			scale:.40,
			backwardsImg:'richardSprites/richardFallbackwards.png',
			temp:null,
			offset:{
				x:60,
				y:70
		...
		attack1:{
			imageSrc:'richardSprites/richardAttack1.png',
			framesMax:5,
			framesHold:6,
			scale:.9,
			backwardsImg:'richardSprites/richardAttack1backwards.png',
			temp:null,
			offset:{
				x:70,
				y:80
		...
		death:{
			imageSrc:'richardSprites/richardDeath.png',
			framesMax:9,
			framesHold:6,
			scale:1.6,
			backwardsImg:'richardSprites/richardDeathbackwards.png',
			temp:null,
			offset:{
				x:70,
				y:80
...
const fighterPortraits=['dracSprites/dracPortrait.png','richardSprites/richardPortrait.png']
